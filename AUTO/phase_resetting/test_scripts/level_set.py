...
import auto
import python_files.auto_functions as data_funcs
...
# #------------------#
# # This run name
# run_new_str = 'run08_level_set_perturbation'
# # Previous run name
...
# SP_points = linspace(0.0, 1.0, 21)
# # SP_points = [0.05, 0.1, 25.0, 30.0]

# # Copy continuation script
# auto.copy('./continuation_scripts/', 'level_set_initial')

# # Try set up phase reset calculation lol
# run08_level_set_perturbation = auto.run(c='level_set_initial', PAR=par_PR, parnames=pnames_PR, DS='-',
#                                         NTST=par_PR[6] * 50,
...
# #-------------------#
# # Save data
# data_funcs.save_move_data(run08_level_set_perturbation, run_new_str)
...
# #------------------#
# # This run name
# run_new_str = 'run09_level_set_single'
# # Previous run name
# run_old_str = 'run08_level_set_perturbation'
# run_old = data_funcs.bd_read(run_old_str)
# # Previous solution label
...
# print('Compute single level set (test)')
# print('Run name: {}'.format(run_new_str))
# print('Continuing from point {} in run: {}'.format(label_old, run_old_str))
...
# run09_level_set_single = auto.run(run_old(label_old), LAB=1,
#                                   ICP=['A_perturb', 'theta_perturb', 'eta', 'mu_s', 'T'],
#                                   NMX=1600, NPR=500,
#                                   UZR={},
#                                   UZSTOP={})
# run09_level_set_single += auto.run(DS='-')

# #-------------------#
# #     Save Data     #
# #-------------------#
# # Merge results
# run09_level_set_single = auto.merge(run09_level_set_single)
# # Relabel results
# run09_level_set_single = auto.relabel(run09_level_set_single)

# data_funcs.save_move_data(run09_level_set_single, run_new_str)

# #--------------#
# #     Plot     #
# #--------------#
# # Plot single PTC solution
# plot_PTC.plot_single_level_set(run09_level_set_single)
...
#------------------#
# This run name
run_new_str = 'run09_level_set_scan'
# Previous run name
run_old_str = 'run08_level_set_perturbation'
run_old = data_funcs.bd_read(run_old_str)
# Previous solution label
...
#     Plot     #
#--------------#
# Save all data to MATLAB .mat file
plot_PTC.save_level_set_scan(run_new_str)

# Plot all PTC
plot_PTC.plot_multi_level_set(run_new_str)
