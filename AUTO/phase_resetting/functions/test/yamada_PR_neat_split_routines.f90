...
! - SEG1_FUNC      : Vector field encoding of the variational problem of
!                    'Segment 1' of the phase resetting problem.
! - SEG2_FUNC      : Vector field encoding of the variational problem of
!                    'Segment 2' of the phase resetting problem.
! - SEG3_FUNC      : Vector field encoding of the variational problem of
!                    'Segment 3' of the phase resetting problem.
! - SEG4_FUNC      : Vector field encoding of the variational problem of
...
SUBROUTINE FUNC(NDIM, U, ICP, PAR, IJAC, F_out, DFDU, DFDP)
  ...
  !     Segment 1     !
  !-------------------!
  CALL SEG1_FUNC(U_seg1, PAR, F_out(1 : 2*xdim))

  !-------------------!
  !     Segment 2     !
  !-------------------!
  CALL SEG2_FUNC(U_seg2, PAR, F_out(2*xdim+1 : 4*xdim))

  !-------------------!
  !     Segment 3     !
  !-------------------!
  CALL SEG3_FUNC(U_seg3, PAR, F_out(4*xdim+1 : 5*xdim))

  !-------------------!
  !     Segment 4     !
  !-------------------!
  CALL SEG4_FUNC(U_seg4, PAR, F_out(5*xdim+1 : 6*xdim))
...
!--------------------------------!
!     VECTOR FIELD ENCODINGS     !
!--------------------------------!
SUBROUTINE SEG1_FUNC(U, PAR, F_out)
  ...
  ! End of subroutine
END SUBROUTINE SEG1_FUNC

SUBROUTINE SEG2_FUNC(U, PAR, F_out)
  ! Vector field encoding for the vector field corresponding to
  ...
  ! End of subroutine
END SUBROUTINE SEG2_FUNC

SUBROUTINE SEG3_FUNC(U, PAR, F_out)
  ! Vector field encoding for the vector field corresponding to
  ...
  ! End of subroutine
END SUBROUTINE SEG3_FUNC

SUBROUTINE SEG4_FUNC(U, PAR, F_out)
  ! Vector field encoding for the vector field corresponding to
