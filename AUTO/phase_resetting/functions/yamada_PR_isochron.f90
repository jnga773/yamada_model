...
!       PAR(11)  - x1 component of the perturbation vector (d_x),
!       PAR(12)  - x2 component of the perturbation vector (d_y),
!       PAR(13)  - x3 component of the perturbation vector (d_z),
!       PAR(14)  - x1 component of the isochron (iso1),
!       PAR(15)  - x2 component of the isochron (iso2),
!       PAR(16)  - x3 component of the isochron (iso3),
...
SUBROUTINE BCS_SEGS(NDIM, NBC, U0, U1, PAR, BCS_out)
  ...
  REAL(KIND=8)                :: d_x, d_y, d_z
  ! Directional vector
  REAL(KIND=8)                :: d_perturb(xdim)
  ! Isochron parameters
  REAL(KIND=8)                :: iso1, iso2, iso3
  ...
  !     Segment 4     !
  !-------------------!
  BCS_out(18:20) = x0_seg4 - x0_seg3 - d_perturb
  ...
  !     Isochron Monitoring     !
  !-----------------------------!
  BCS_out(23)    = iso1 - x0_seg4(1)
  BCS_out(24)    = iso2 - x0_seg4(2)
  BCS_out(25)    = iso3 - x0_seg4(3)
