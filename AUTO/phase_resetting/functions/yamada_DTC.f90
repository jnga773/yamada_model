...
! resetting problem of the Fitz-Hugh-Nagumo model in AUTO.
!
! This module contains the following subroutines:
! - FIELD         : Vector field encoding of the Fitz-Hugh-Nagumo model.
...
!       PAR(14)  - 'x' component of the perturbation vector (d_x),
!       PAR(15)  - 'y' component of the perturbation vector (d_y),
!       PAR(16)  - 'z' component of the perturbation vector (d_z).
