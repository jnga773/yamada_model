...
%%                             Split Data                                %%
%-------------------------------------------------------------------------%
% Complete PTC data for 0 <= theta_old <= 1 BEFORE the hole

%------------------------%
%     Data: The Hole     %
%------------------------%
% theta_old_hole.gt1 = theta_old_gt1(:, MX_both);
% theta_old_hole.lt1 = theta_old_lt1(:, MX_both);
% 
% theta_new_hole.gt1 = theta_new_gt1(:, MX_both);
% theta_new_hole.lt1 = theta_new_lt1(:, MX_both);
% 
% A_perturb_hole.gt1 = A_perturb_gt1(:, MX_both);
% A_perturb_hole.lt1 = A_perturb_lt1(:, MX_both);
