...
[X, Y, Z] = matrix_data(data_hole_lt1_pad.theta_old, data_hole_lt1_pad.theta_new, data_hole_lt1_pad.A_perturb);
surf(ax, X, Y, Z, MeshStyle='column');

% Surface: Hole (theta_old > 1)
[X, Y, Z] = matrix_data(data_hole_gt1_pad.theta_old, data_hole_gt1_pad.theta_new, data_hole_gt1_pad.A_perturb);
surf(ax, X, Y, Z, MeshStyle='column');

% Surface: Before hole
[X, Y, Z] = matrix_data(data_before_hole_pad.theta_old, data_before_hole_pad.theta_new, data_before_hole_pad.A_perturb);
surf(ax, X, Y, Z, MeshStyle='column');

% Surface: After hole
[X, Y, Z] = matrix_data(data_after_hole_pad.theta_old, data_after_hole_pad.theta_new, data_after_hole_pad.A_perturb);
surf(ax, X, Y, Z, MeshStyle='column');
