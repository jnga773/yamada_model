...
data_funcs.write_initial_solution_PO(run04_hopf_to_PO('UZ1'))

#--------------#
#     Plot     #
#--------------#
plot_PO.plot_hopf_to_PO_solution(run04_hopf_to_PO('UZ1'))
...
data_funcs.write_initial_solution_floquet(run05_initial_PO('EP1'))

#--------------#
#     Plot     #
#--------------#
# Save solution to MATLAB .mat file
data_funcs.save_PO_data_matlab(run05_initial_PO('EP1'))
