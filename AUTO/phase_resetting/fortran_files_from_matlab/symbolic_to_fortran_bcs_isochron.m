...
fortran(bcs, File='./fortran_generated/bcs_Segs_isochron.f90');
...
fortran(bcs_du, File='./fortran_generated/bcs_Segs_DFDU_isochron.f90');
...
% Write to Fortran file
fortran(bcs_dp, File='./fortran_generated/bcs_Segs_DFDP_isochron.f90');
