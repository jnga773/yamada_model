...
%------------------%
% Current run name
run_names.phase_reset_perturbation = 'run05_PTC_perturbation';
...
%------------------%
% Current run name
run_names.phase_transition_curve = 'run06_PTC_single';
...
%------------------%
% Current run name
run_names.phase_transition_curve = 'run07_PTC_scan';
run_new = run_names.phase_transition_curve;
% Which run this continuation continues from
run_old = run_names.phase_reset_perturbation;
