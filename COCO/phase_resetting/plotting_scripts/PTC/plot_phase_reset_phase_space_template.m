function plot_phase_reset_phase_space_template(ax_in, run_in, label_in)
  ...
  % Plot segment 1
  plot3(ax_in, x1(:, 1), x1(:, 2), x1(:, 3), LineWidth=2.0, Color=colours(1, :), ...
        DisplayName='Segment 1');

  % Plot segment 2
  plot3(ax_in, x2(:, 1), x2(:, 2), x2(:, 3), LineWidth=2.0, Color=colours(2, :), ...
        DisplayName='Segment 2');

  % Plot segment 3
  plot3(ax_in, x3(:, 1), x3(:, 2), x3(:, 3), LineWidth=2.0, Color=colours(3, :), ...
        DisplayName='Segment 3');

  % Plot segment 4
  plot3(ax_in, x4(:, 1), x4(:, 2), x4(:, 3), LineWidth=2.0, Color=[colours(4, :), 0.7], ...
