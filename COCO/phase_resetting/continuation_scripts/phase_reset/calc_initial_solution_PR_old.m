function data_out = calc_initial_solution_PR_old(filename_in, k_in, theta_perturb_in, phi_perturb_in, options)
  % data_out = calc_initial_solution_PR_old(filename_in, k_in, theta_perturb_in, phi_perturb_in, options)
  %
