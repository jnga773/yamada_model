...
prob = coco_add_event(prob, 'H_PT', 'A', 6.715);
% prob = coco_add_event(prob, 'H_PT', 'A', 6.815);
...
prob = coco_add_event(prob, 'PO_PT', 'gamma', 7.52e-2);
% prob = coco_add_event(prob, 'PO_PT', 'gamma', 6.75e-2);

%------------------%
%     Run COCO     %
%------------------%
% Run COCO continuation
bdtest = coco(prob, run_names.hopf_to_PO, [], 1, {'gamma', 'A'}, gamma_range);
