...
%------------------%
% Current run name
run_names.move_along_PO = 'PR_along_PO';
run_new = run_names.move_along_PO;
...
plot_phase_reset_phase_space(run_new, 9, 1);
...
%------------------%
% Current run name
run_names.PR_perturb = 'PR_increase_Ap';
run_new = run_names.PR_perturb;
% Which run this continuation continues from
run_old = run_names.move_along_PO;
...
fprintf('Fix theta_old and increase A_perturb \n');
fprintf('Run name: %s \n', run_new);
...
plot_perturbed_states(run_new, label_plot, 2);
