function prob_out = apply_W_PO_conditions(prob_in, bcs_funcs_in, eps_in, vec_floquet_in, lam_floquet_in)
  ...
  prob = coco_add_glue(prob, 'pars_glue', ...
                       [uidx_s(maps_s.p_idx); uidx_s(maps_s.p_idx); uidx_s(maps_s.p_idx); uidx_s(maps_s.p_idx); uidx_s(maps_s.p_idx); uidx_s(maps_s.p_idx)], ...
                       [uidx_u(maps_u.p_idx(1:data_s.pdim)); uidx_0(maps_0.p_idx); uidx_pos(maps_pos.p_idx); uidx_neg(maps_neg.p_idx); uidx1(maps1.p_idx); uidx2(maps2.p_idx)]);
  ...
  %                      'zero', 'uidx', ...
  %                      [uidx_u_var(maps_u_var.v1_idx(:, 1)); ...
  %                       uidx_u_var(maps_u_var.v1_idx(:, 2)); ...
  %                       uidx_u_var(maps_u_var.v1_idx(:, 3))], ...
  ...
  prob = coco_add_func(prob, 'bcs_T', bcs_T{:}, [], 'zero', ...
                       'uidx', uidx_u(maps_u.T_idx));
